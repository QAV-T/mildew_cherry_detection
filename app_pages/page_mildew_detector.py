...
def upload_and_predict(images_buffer):
    if images_buffer is not None:
        ...
        for image in images_buffer:
            ...
            version = 'v1'
            resized_img = resize_input_image(img=img)
...
#         pred_class = 'Healthy' if prediction < 0.5 else 'Mildew'
        
#         st.image(img, caption=f'Uploaded Image. Predicted: {pred_class}')
#         st.write(f'Prediction: {pred_class}, Probability: {prediction:.2f}')
